...
| [event-end](#eventtype-event-end-pro-režimy-simple) | Magnet přiblížen zpět, konec poplachu.                                     |
...
Čidlo v transportním režimu má velmi nízkou spotřebu a neposílá žádné zprávy. Pro probuzení čidla z transportního režimu
je třeba stisknout RESET tlačítko umístěné na plošném spoji čidla.
...
> DeviceType u kterých může tato událost nastat: `magnetic-detection-simple`
